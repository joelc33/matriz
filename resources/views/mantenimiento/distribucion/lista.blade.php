...
this.gridPanel_ = new Ext.grid.GridPanel({
    ...
    {header: 'id',hidden:true, menuDisabled:true,dataIndex: 'id'},
		{header: 'Municipio', width:100,  menuDisabled:true, sortable: true, dataIndex: 'nu_descripcion'},
		{header: 'Proyeccion Poblacion', width:100,  menuDisabled:true, sortable: true, dataIndex: 'de_objetivo_sectorial'},
    {header: 'Factor Poblacion', width:100,  menuDisabled:true, sortable: true, dataIndex: 'de_objetivo_sectorial'},
    {header: '45% P.I', width:100,  menuDisabled:true, sortable: true, dataIndex: 'de_objetivo_sectorial'},
    {header: '50% F.P', width:100,  menuDisabled:true, sortable: true, dataIndex: 'de_objetivo_sectorial'},
    {header: 'Sup. KM2', width:100,  menuDisabled:true, sortable: true, dataIndex: 'de_objetivo_sectorial'},
    {header: 'F. Sup.', width:100,  menuDisabled:true, sortable: true, dataIndex: 'de_objetivo_sectorial'},
    {header: 'Monto Situado', width:120,  menuDisabled:true, sortable: true, dataIndex: 'in_activo'},
    ],
    stripeRows: true,
    autoScroll:true,
    stateful: true,
