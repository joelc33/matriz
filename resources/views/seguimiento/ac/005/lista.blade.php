...
this.eliminar= new Ext.Button({
	...
	if(boton=="yes"){
        Ext.Ajax.request({
            ...
            params:{
		_token: '{{ csrf_token() }}',
                id: forma005Lista.main.gridPanel_.getSelectionModel().getSelected().get('id')
            },
...
this.gridPanel_ = new Ext.grid.GridPanel({
    ...
    listeners:{cellclick:function(Grid, rowIndex, columnIndex,e ){
			forma005Lista.main.editar.enable();
			forma005Lista.main.habilitar.enable();
			forma005Lista.main.eliminar.enable();
		}},
...
forma005Lista.main.editar.disable();
forma005Lista.main.habilitar.disable();
forma005Lista.main.eliminar.disable();
});
