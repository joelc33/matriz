...
this.OBJ = paqueteComunJS.funcion.doJSON({stringData:'{!! $data !!}'});
    ...
    iconCls: 'icon-nuevo',
    handler:function(){
	forma005ActividadLista.main.mascara.show();
        this.msg = Ext.get('forma005Actividad');
        this.msg.load({
...
this.editar= new Ext.Button({
    ...
    handler:function(){
	this.codigo  = forma005ActividadLista.main.gridPanel_.getSelectionModel().getSelected().get('id');
	forma005ActividadLista.main.mascara.show();
        this.msg = Ext.get('forma005Actividad');
        this.msg.load({
         url:"{{ URL::to('ac/seguimiento/005/actividad/editar') }}/"+this.codigo,
         scripts: true,
         text: "Cargando.."
        });
    }
	...
	handler: function(boton){
		...
		if(boton=="yes"){
	        Ext.Ajax.request({
	            ...
	            params:{
			_token: '{{ csrf_token() }}',
	                id: forma005ActividadLista.main.gridPanel_.getSelectionModel().getSelected().get('id')
	            },
	            success:function(result, request ) {
	                obj = Ext.util.JSON.decode(result.responseText);
	                if(obj.success=="true"){
			    forma005ActividadLista.main.store_lista.load();
	                    Ext.Msg.alert("Notificación",obj.msg);
	                }else{
	                    Ext.Msg.alert("Notificación",obj.msg);
	                }
	                forma005ActividadLista.main.mascara.hide();
	            }});
		}});
	}
});
...
this.buscador = new Ext.form.TwinTriggerField({
	...
	onTrigger1Click : function() {
		...
		forma005ActividadLista.main.store_lista.baseParams={};
		forma005ActividadLista.main.store_lista.baseParams.paginar = 'si';
		forma005ActividadLista.main.store_lista.baseParams._token = '{{ csrf_token() }}';
    forma005ActividadLista.main.store_lista.baseParams.ac_ae = '{{ $data['id'] }}';
		forma005ActividadLista.main.store_lista.load();
	},
	onTrigger2Click : function(){
		...
		if(v.length < 1){
			...
			forma005ActividadLista.main.store_lista.baseParams={}
			forma005ActividadLista.main.store_lista.baseParams.BuscarBy = true;
			forma005ActividadLista.main.store_lista.baseParams._token = '{{ csrf_token() }}';
      forma005ActividadLista.main.store_lista.baseParams.ac_ae = '{{ $data['id'] }}';
			forma005ActividadLista.main.store_lista.baseParams[this.paramName] = v;
			forma005ActividadLista.main.store_lista.baseParams.paginar = 'si';
			forma005ActividadLista.main.store_lista.load();
		}
	}
...
//    {header: 'Estatus', width:130,  menuDisabled:true, sortable: true, renderer: actividadEstado, dataIndex: 'id_tab_estatus'},
    ...
    listeners:{cellclick:function(Grid, rowIndex, columnIndex,e ){
			forma005ActividadLista.main.editar.enable();
                        if(forma005ActividadLista.main.gridPanel_.getSelectionModel().getSelected().get('id_tab_origen')==2){
                        forma005ActividadLista.main.eliminar.enable();    
                        }else{
                        forma005ActividadLista.main.eliminar.disable();      
                        }
		}},
...
forma005DetalleLista{!! $data['id_tab_ac'] !!}.main.mascara.hide();
...
forma005ActividadLista.main.editar.disable();
forma005ActividadLista.main.eliminar.disable();
});
...
Ext.onReady(forma005ActividadLista.main.init, forma005ActividadLista.main);
</script>
