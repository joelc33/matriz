...
this.eliminar= new Ext.Button({
	...
	if(boton=="yes"){
        Ext.Ajax.request({
            ...
            params:{
		_token: '{{ csrf_token() }}',
                id: forma003Lista.main.gridPanel_.getSelectionModel().getSelected().get('id')
            },
...
this.gridPanel_ = new Ext.grid.GridPanel({
    ...
    listeners:{cellclick:function(Grid, rowIndex, columnIndex,e ){
			forma003Lista.main.editar.enable();
			forma003Lista.main.habilitar.enable();
			forma003Lista.main.eliminar.enable();
		}},
...
forma003Lista.main.editar.disable();
forma003Lista.main.habilitar.disable();
forma003Lista.main.eliminar.disable();
});
