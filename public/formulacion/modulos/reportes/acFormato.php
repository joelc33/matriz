...
<tr style="font-size:9px">
<td colspan="2" style="width: 70%;" align="justify">OBJETIVO(S) ESTRATEGICO(S): '.$campo['tx_objetivo_estrategico'].'</td>
</tr>
<tr style="font-size:9px">
<td colspan="3" align="justify">OBJETIVO GENERAL: '.$campo['tx_objetivo_general'].'</td>
</tr>
<tr style="font-size:9px">
...
<tr style="font-size:9px">
<td colspan="3" style="width: 100%;" align="justify">PRODUCTO PROGRAMADO ANUAL DEL OBJETIVO INSTITUCIONAL: '.$campo['tx_pr_objetivo'].'</td>
</tr>
</tbody>
</table>
';	
...
<td rowspan="2" colspan="2" align="left"><b>'.$this->formatoDinero($campo['monto_calc']).'</b></td>
