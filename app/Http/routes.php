...
Route::group(['namespace' => 'Reporte'], function () {
    ...
    Route::group(['prefix' => 'reporte'], function () {
        ...
        Route::get('ac/seguimiento/consolidado/exportarAF/{id_lapso}', 'acseguimientoController@exportarAF');
        Route::get('ac/seguimiento/consolidado/exportarAC/{id_lapso}', 'acseguimientoController@exportarAC');
...
Route::group(['namespace' => 'AcSeguimiento'], function () {
    ...
    Route::group(['prefix' => 'ac/seguimiento/002'], function () {
        ...
        Route::post('actividad/guardarFoco', 'formadosController@guardarFoco');
    });    
    //*Modulo de Accion Centralizada Forma 002*/
