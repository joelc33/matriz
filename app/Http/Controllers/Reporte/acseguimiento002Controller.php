...
//exit();
        ...
        $periodo = 'LAPSO '.$data->fe_inicio.' - '.$data->fe_fin;    
          ...
          Session::put('periodo',$periodo);               
            ...
            't002.nb_responsable','de_unidad_medida as tx_unidades_medida',DB::raw('coalesce(tab_meta_fisica.nu_meta_modificada,0) as nu_meta_modificada'),'de_municipio','de_parroquia','tab_meta_fisica.resultado','tab_meta_fisica.observacion',
