...
class leyController extends Controller
{
    ...
    public function libro()
    {
        ...
        $pdf->SetFont('', 'B', 5);
        $pdf->MultiCell(20, 5, '', 0, 'C', 0, 0, '', '', true);
        $pdf->MultiCell(21, 5, 'N° DE CARGOS', 1, 'C', 0, 0, '', '', true);
        ...
        $pdf->SetFont('', 'B', 4);
        $pdf->MultiCell(20, 5, '', 0, 'C', 0, 0, '', '', true);
        $pdf->MultiCell(7, 5, chr(10).'M', 1, 'C', 0, 0, '', '', true);
        $pdf->MultiCell(7, 5, chr(10).'F', 1, 'C', 0, 0, '', '', true);
        $pdf->MultiCell(7, 5, 'TOTAL', 1, 'C', 0, 0, '', '', true);
        $pdf->ln(-5);
        $pdf->SetFont('', 'B', 5);
        ...
        $pdf->MultiCell(7, 215, '', 1, 'C', 0, 0, '', '', true);
        $pdf->MultiCell(7, 215, '', 1, 'L', 0, 0, '', '', true);
        $pdf->MultiCell(7, 215, '', 1, 'L', 0, 0, '', '', true);
        ...
        $pdf->MultiCell(5, 215, '', 1, 'C', 0, 0, '', '', true);
        $pdf->MultiCell(5, 215, '', 1, 'L', 0, 0, '', '', true);
        $pdf->MultiCell(5, 215, '', 1, 'L', 0, 0, '', '', true);
        $pdf->MultiCell(20, 215, '', 1, 'L', 0, 0, '', '', true);
        $pdf->MultiCell(15, 215, '', 1, 'L', 0, 0, '', '', true);
        $pdf->MultiCell(18, 215, '', 1, 'L', 0, 0, '', '', true);
