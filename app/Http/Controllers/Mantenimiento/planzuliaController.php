  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select('id', 'co_ambito_zulia', 'co_objetivo_zulia', 'co_macroproblema', 'co_nodo',
       'nu_nivel', 'tx_descripcion', 'co_area_estrategica', 'in_activo' );
  ...
  {
    $data = tab_planes_zulia::select('id', 'co_ambito_zulia', 'co_objetivo_zulia', 'co_macroproblema', 'co_nodo',
     'nu_nivel', 'tx_descripcion', 'co_area_estrategica', 'in_activo')
    ->where('id', '=', $id)
    ->first();
    return View::make('mantenimiento.plan.editar')->with('data',$data);
