  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select( 'mantenimiento.tab_objetivo_sectorial.id', 'id_tab_ejercicio_fiscal', 'id_tab_sectores', 'de_objetivo_sectorial',
      'mantenimiento.tab_objetivo_sectorial.in_activo', 'nu_descripcion')
  ...
  {
    $data = tab_objetivo_sectorial::select('id', 'id_tab_ejercicio_fiscal', 'id_tab_sectores', 'de_objetivo_sectorial',
       'in_activo')
    ->where('id', '=', $id)
    ->first();
    return View::make('mantenimiento.objetivosectorial.editar')->with('data',$data);
