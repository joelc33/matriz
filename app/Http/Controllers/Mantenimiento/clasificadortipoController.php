  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select( 'mantenimiento.tab_clasificador_tipo.id', 'id_tab_ejercicio_fiscal', 'id_tab_tipo_personal', 'nu_masculino',
       'nu_femenino', 'mo_sueldo', 'mo_compensacion', 'mo_primas',
       'mantenimiento.tab_clasificador_tipo.in_activo', 'nu_codigo', 'de_tipo_personal' );
  ...
  {
    $data = tab_clasificador_tipo::select('id', 'id_tab_ejercicio_fiscal', 'id_tab_tipo_personal', 'nu_masculino',
     'nu_femenino', 'mo_sueldo', 'mo_compensacion', 'mo_primas', 'in_activo' )
    ->where('id', '=', $id)
    ->first();
    return View::make('mantenimiento.clasificadortipo.editar')->with('data',$data);
  }
