...
class ejecutorController extends Controller
{
    ...
    */
    ...
    /**
  	...
  	public function storeLista()
  	{
  		try {
  			...
  			->select('id', 'id_ejecutor', 'tx_ejecutor', 'car_01', 'car_02', 'car_03', 'car_04',
       'id_tab_tipo_ejecutor', 'id_tab_ambito_ejecutor', 'codigo_01', 'codigo_eje',
       'in_activo', 'de_correo', 'de_telefono', 'in_verificado');
    ...
    {
      $data = tab_ejecutores::select('id', 'id_ejecutor', 'tx_ejecutor', 'car_01', 'car_02', 'car_03', 'car_04',
     'id_tab_tipo_ejecutor', 'id_tab_ambito_ejecutor', 'codigo_01', 'codigo_eje',
     'in_activo', 'de_correo', 'de_telefono', 'in_verificado')
      ->where('id', '=', $id)
      ->first();
