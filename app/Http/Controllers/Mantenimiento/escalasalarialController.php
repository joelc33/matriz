  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select( 'mantenimiento.tab_escala_salarial.id', 'id_tab_ejercicio_fiscal', 'id_tab_tipo_empleado', 'de_grupo',
       'de_escala_salarial', 'nu_masculino', 'nu_femenino', 'mo_escala_salarial',
       'mantenimiento.tab_escala_salarial.in_activo', 'de_tipo_empleado' )
  ...
  {
    $data = tab_escala_salarial::select('id', 'id_tab_ejercicio_fiscal', 'id_tab_tipo_empleado', 'de_grupo',
     'de_escala_salarial', 'nu_masculino', 'nu_femenino', 'mo_escala_salarial',
     'in_activo')
    ->where('id', '=', $id)
    ->first();
