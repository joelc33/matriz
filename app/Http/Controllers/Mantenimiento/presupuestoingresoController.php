  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select( 'id', 'id_tab_ejercicio_fiscal', 'nu_partida', 'de_partida', 'mo_partida',
       'in_activo' )
  ...
  {
    $data = tab_presupuesto_ingreso::select('id', 'id_tab_ejercicio_fiscal', 'nu_partida', 'de_partida', 'mo_partida',
     'in_activo')
    ->where('id', '=', $id)
    ->first();
    return View::make('mantenimiento.presupuestoingreso.editar')->with('data',$data);
