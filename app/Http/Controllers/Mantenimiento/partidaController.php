  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select('id', 'id_tab_ejercicio_fiscal', 'co_partida', 'tx_nombre', 'tx_abreviacion',
       'ace_mov', 'in_activo' );
  ...
  {
    $data = tab_partidas::select('id', 'id_tab_ejercicio_fiscal', 'co_partida', 'tx_nombre', 'tx_abreviacion',
     'ace_mov', 'in_activo')
    ->where('id', '=', $id)
    ->first();
    return View::make('mantenimiento.partida.editar')->with('data',$data);
