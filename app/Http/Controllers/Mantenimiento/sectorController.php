  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select('id', 'co_sector', 'co_sub_sector', 'nu_nivel', 'tx_codigo', 'tx_descripcion',
       'nu_descripcion', 'in_activo');
  ...
  {
    $data = tab_sectores::select('id', 'co_sector', 'co_sub_sector', 'nu_nivel', 'tx_codigo', 'tx_descripcion',
     'nu_descripcion', 'in_activo')
    ->where('id', '=', $id)
    ->first();
    return View::make('mantenimiento.sector.editar')->with('data',$data);
