  ...
  */
  ...
  DB::beginTransaction();
    if($id!=''||$id!=null){
      ...
      $tab_ac_ae = ac_ae::select( 'id_accion_centralizada', 'id_accion', 'public.t47_ac_accion_especifica.id_ejecutor', 'bien_servicio',
       ...
       'objetivo_institucional', 'id_tab_ejecutor', 'in_definitivo', 't01.id as id_tab_ejecutores')
