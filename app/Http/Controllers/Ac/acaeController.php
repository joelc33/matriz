  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      ->select( 'id_accion_centralizada', 'id_accion', 'public.t47_ac_accion_especifica.id_ejecutor', 'bien_servicio',
       'id_unidad_medida', 'meta', 'monto', 'monto_calc',
       'edo_reg', 'tx_ejecutor', 'nu_numero as numero', 'objetivo_institucional',
       'de_nombre as nombre', 'de_unidad_medida as tx_unidades_medida',
