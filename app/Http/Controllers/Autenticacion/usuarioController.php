    ...
    */
    ...
    public function storeLista()
    {
      try {
        ...
        ->select('autenticacion.tab_usuarios.id','da_login',
        DB::raw("inicial||'-'||nu_cedula as nu_cedula"), 'nb_funcionario', 'ap_funcionario',
        'autenticacion.tab_usuarios.in_estatus','de_rol','tx_ejecutor');
    ...
    public function editar($id)
    {
      $data = tab_usuarios::join('autenticacion.tab_usuario_rol as t01', 'autenticacion.tab_usuarios.id', '=', 't01.id_tab_usuarios')
      ->join('mantenimiento.tab_funcionario as t02', 'autenticacion.tab_usuarios.id', '=', 't02.id_tab_usuarios')
      ->select('autenticacion.tab_usuarios.id', 'da_login', 'da_email', 'id_tab_rol',
      't02.id as id_funcionario', 'id_tab_documento', 'nu_cedula', 'nb_funcionario', 'ap_funcionario',
       'id_tab_cargo', 'tx_direccion', 'tx_telefono', 'id_tab_ejecutores')
