...
class formaunoController extends Controller
{
  ...
  */
  ...
  public function storeLista()
  {
    try {
      ...
      'proyecto_seguimiento.tab_proyecto.id_ejecutor', 'in_001' )
  ...
  */
  ...
  public function storeListaCambio()
  {
    try {
      ...
      ->select( 'proyecto_seguimiento.tab_forma_001.id', 'tx_ejecutor', 't01.id_tab_ejecutores',
      ...
      'proyecto_seguimiento.tab_forma_001.de_proyecto', 'proyecto_seguimiento.tab_forma_001.in_001', 't01.id_ejecutor',
  ...
  */
  public function detalleCambio()
  {
    ...
    DB::raw("to_char(t03.fe_inicio, 'dd/mm/YYYY') as fe_inicio"),
    DB::raw("to_char(t03.fe_fin, 'dd/mm/YYYY') as fe_fin"), 'nu_codigo', 'proyecto_seguimiento.tab_forma_001.de_observacion',
    'proyecto_seguimiento.tab_forma_001.de_proyecto', 'proyecto_seguimiento.tab_forma_001.in_001', 't01.id_ejecutor', 'de_nombre',
    DB::raw("to_char(proyecto_seguimiento.tab_forma_001.created_at, 'dd/mm/YYYY hh12:mi AM') as fe_solicitud") )
  ...
  */
  ...
  {
    $data = tab_forma_001::select( 'id', 'id_tab_proyecto', 'de_objetivo', 'de_proyecto', 'in_activo', 'in_001',
       'created_at', 'updated_at', 'de_observacion', 'id_usuario_solicita',
       'id_usuario_procesa', 'id_tab_estatus')
    ->where('id', '=', $id)
    ->first();
