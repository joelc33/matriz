  ...
  */
  ...
  DB::beginTransaction();
    if($id!=''||$id!=null){
      ...
      $tab_proyecto = proyecto::
      select( 'co_proyectos', 'id_ejercicio', 'id_ejecutor', 'id_proyecto', 'tipo_registro',
       'nombre', 'status_registro', 'codigo_new_etapa', 'fecha_inicio', 'fecha_fin',
       'objetivo', 'descripcion', 'sit_presupuesto', 'monto', 'clase_sector',
       'clase_subsector', 'plan_operativo', 'co_estatus', 'edo_reg', 'fecha_creacion',
       'fecha_actualizacion', 'id_tab_ejecutor')
      ->where('edo_reg', '=', true)
      ->where('co_estatus', '=', 3)
      ...
      $tab_proyecto_ae = proyecto_ae::select( 'co_proyecto_acc_espec', 'tx_codigo', 'id_proyecto', 'descripcion', 'co_unidades_medida',
       'meta', 'ponderacion', 'bien_servicio', 'total', 'fec_inicio', 'fec_termino',
       'co_ejecutores', 'fecha_creacion', 'fecha_actualizacion', 'edo_reg',
       'tx_objetivo_institucional', 'id_padre', 'in_definitivo', 'id_ejecutor')
